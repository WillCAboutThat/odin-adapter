...
from .code import CodeTextExtractor  # stdlib — plain-text source/config formats
register(CodeTextExtractor())      # .sql/.js/.py/.json/... (stdlib)
...
try:  # .xlsx/.xlsm fall back to bytes-only if openpyxl isn't installed
