...
**Anyone may implement this format, for any purpose, without permission or fee**
— validating against these schemas, or writing conformant documents, requires no
license grant back, no attribution to claim conformance, and no dependency on
Odin's code. The full statement, and why the permission is load-bearing rather
than polite, is in [`docs/muninn/SPEC.md`](../docs/muninn/SPEC.md) under
